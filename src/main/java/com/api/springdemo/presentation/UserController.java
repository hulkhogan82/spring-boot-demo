...
import com.api.springdemo.repository.UserRepository;
...
public class UserController {
    ...
    @ApiOperation(value = "User related Endpoints", response = Iterable.class)
    @ApiResponses(value = {
    ...
    public @ResponseBody Iterable<User> getUserByName(@RequestParam final String name) {
		// This returns a JSON or XML with the users
